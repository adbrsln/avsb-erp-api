    ...
    public function update(Request $request): JsonResponse
    {
        ...
        if (! $settings) {
            ...
            $settings->update(fillableData($settings, [
                ...
                'sst_registration_no' => $body['sst_registration_no'] ?? $settings->sst_registration_no,
                'tax_id_number' => $body['tax_id_number'] ?? $settings->tax_id_number,
                'msic_code' => $body['msic_code'] ?? $settings->msic_code,
                'msic_description' => $body['msic_description'] ?? $settings->msic_description,
                'business_phone' => $body['business_phone'] ?? $settings->business_phone,
                'business_email' => $body['business_email'] ?? $settings->business_email,
                'payroll_bank_account' => $body['payroll_bank_account'] ?? $settings->payroll_bank_account,
