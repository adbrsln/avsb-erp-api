...
class StaffProfile extends Model
{
    ...
    protected $fillable = [
        ...
        'pcb_borne_by_employer', 'socso_contribution_type', 'socso_contributing',
        ...
        'spouse', 'address', 'emergency_contact', 'dependent_children', 'children_tax',
